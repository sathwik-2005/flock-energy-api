...
- **Live demo**: https://flock-energy-api-0rk2.onrender.com/docs — interactive
  Swagger UI, hitting the real portal live. Hosted on Render's free tier, so
  it spins down after ~15 minutes idle — the first request after that can
  take 30-50 seconds to wake back up; subsequent requests are fast.
